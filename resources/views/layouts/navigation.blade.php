        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif (in_array(Auth::user()->level, ['apoteker']))
                        <x-nav-link :href="route('apoteker.dashboard')" :active="request()->routeIs('apoteker.dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    @elseif (in_array(Auth::user()->level, ['kasir']))
